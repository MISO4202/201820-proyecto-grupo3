		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExpresionLogicaAccess().getIzqAssignment_1(), "rule__ExpresionLogica__IzqAssignment_1");
					put(grammarAccess.getExpresionLogicaAccess().getOperadorAssignment_2(), "rule__ExpresionLogica__OperadorAssignment_2");
					put(grammarAccess.getExpresionLogicaAccess().getDerAssignment_3(), "rule__ExpresionLogica__DerAssignment_3");
					put(grammarAccess.getExpresionAritmeticaAccess().getIzqAssignment_1(), "rule__ExpresionAritmetica__IzqAssignment_1");
					put(grammarAccess.getExpresionAritmeticaAccess().getOperadorAssignment_2(), "rule__ExpresionAritmetica__OperadorAssignment_2");
					put(grammarAccess.getExpresionAritmeticaAccess().getDerAssignment_3(), "rule__ExpresionAritmetica__DerAssignment_3");
					...
					put(grammarAccess.getCondicionalAccess().getLineaAssignment_5(), "rule__Condicional__LineaAssignment_5");
					put(grammarAccess.getCondicionalAccess().getElseAssignment_7(), "rule__Condicional__ElseAssignment_7");
					put(grammarAccess.getElseAccess().getLineaAssignment_3(), "rule__Else__LineaAssignment_3");
					...
					put(grammarAccess.getExpresionReferenciadaAccess().getReferenciaAssignment_1(), "rule__ExpresionReferenciada__ReferenciaAssignment_1");
