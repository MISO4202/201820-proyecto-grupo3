		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRetornoAccess().getGroup(), "rule__Retorno__Group__0");
					...
					put(grammarAccess.getOperacionAccess().getLineasAssignment_9(), "rule__Operacion__LineasAssignment_9");
					...
					put(grammarAccess.getRetornoAccess().getLineaRetornoAssignment_2(), "rule__Retorno__LineaRetornoAssignment_2");
