 ...
 * </p>
 * <ul>
 *   <li>{@link blockchain.impl.MapaImpl#getTipoDatoKey <em>Tipo Dato Key</em>}</li>
 *   <li>{@link blockchain.impl.MapaImpl#getTipoDatoValue <em>Tipo Dato Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapaImpl extends TipoDatoImpl implements Mapa {
	/**
	...
	protected EClass eStaticClass() {
		return BlockchainPackage.Literals.MAPA;
	}
		...
		if (tipoDatoKey != null && tipoDatoKey.eIsProxy()) {
			...
			if (tipoDatoKey != oldTipoDatoKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BlockchainPackage.MAPA__TIPO_DATO_KEY, oldTipoDatoKey, tipoDatoKey));
			}
		}
		return tipoDatoKey;
	}
	...
	public void setTipoDatoKey(TipoDato newTipoDatoKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlockchainPackage.MAPA__TIPO_DATO_KEY, oldTipoDatoKey, tipoDatoKey));
	}
	...
	public TipoDato getTipoDatoValue() {
		if (tipoDatoValue != null && tipoDatoValue.eIsProxy()) {
			...
			if (tipoDatoValue != oldTipoDatoValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BlockchainPackage.MAPA__TIPO_DATO_VALUE, oldTipoDatoValue, tipoDatoValue));
			}
		}
	...
	public void setTipoDatoValue(TipoDato newTipoDatoValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlockchainPackage.MAPA__TIPO_DATO_VALUE, oldTipoDatoValue, tipoDatoValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BlockchainPackage.MAPA__TIPO_DATO_KEY:
				if (resolve) return getTipoDatoKey();
				return basicGetTipoDatoKey();
			case BlockchainPackage.MAPA__TIPO_DATO_VALUE:
