 ...
 *   <li>{@link blockchain.If#getElse <em>Else</em>}</li>
 * </ul>
 *
...
public interface If extends Sentencia {
	 ...
	 * @see #setElse(Else)
	 * @see blockchain.BlockchainPackage#getIf_Else()
	 * @model containment="true"
	 * @generated
	 */
	Else getElse();
	...
	/**
	 * Sets the value of the '{@link blockchain.If#getElse <em>Else</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
