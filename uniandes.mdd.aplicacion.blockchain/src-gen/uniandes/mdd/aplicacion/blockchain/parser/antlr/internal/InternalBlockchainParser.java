...
public class InternalBlockchainParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_STRING", "RULE_ID", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'Aplicacion'", "'{'", "'tipodato'", "'}'", "'SmartContract'", "'Entidad'", "'Operacion'", "'isUd='", "'('", "','", "')'", "':'", "'return'", "'Estado'", "'true'", "'false'", "'ExpLog'", "'ExpArit'", "'var'", "'if'", "'ExpNum'", "'ExpTex'", "'ExpBool'", "'ExpRef'", "'id'", "'ExpRel'", "'-'", "'.'", "'E'", "'e'", "'Map'", "'<'", "'>'", "'=='", "'!='", "'>='", "'<='", "'&&'", "'||'", "'+'", "'*'", "'/'", "'='", "'GET'", "'DELETE'", "'String'", "'uint'", "'Boolean'", "'address'"
    };
    ...
    public final EObject ruleOperacion() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( ((LA22_0>=27 && LA22_0<=34)||LA22_0==36) ) {
                    alt22=1;
                }
    ...
    public final EObject ruleExpresionAritmetica() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA32_0==37||(LA32_0>=50 && LA32_0<=55)) ) {
                alt32=1;
            }
            switch (alt32) {
                case 1 :
    ...
    // InternalBlockchain.g:1323:1: ruleCondicional returns [EObject current=null] : ( () otherlv_1= 'if' ( (lv_expresionlogica_2_0= ruleExpresionLogica ) )? otherlv_3= '{' ( (lv_validador_4_0= ruleLinea ) )* otherlv_5= '}' ) ;
    public final EObject ruleCondicional() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1329:2: ( ( () otherlv_1= 'if' ( (lv_expresionlogica_2_0= ruleExpresionLogica ) )? otherlv_3= '{' ( (lv_validador_4_0= ruleLinea ) )* otherlv_5= '}' ) )
            // InternalBlockchain.g:1330:2: ( () otherlv_1= 'if' ( (lv_expresionlogica_2_0= ruleExpresionLogica ) )? otherlv_3= '{' ( (lv_validador_4_0= ruleLinea ) )* otherlv_5= '}' )
            {
            // InternalBlockchain.g:1330:2: ( () otherlv_1= 'if' ( (lv_expresionlogica_2_0= ruleExpresionLogica ) )? otherlv_3= '{' ( (lv_validador_4_0= ruleLinea ) )* otherlv_5= '}' )
            // InternalBlockchain.g:1331:3: () otherlv_1= 'if' ( (lv_expresionlogica_2_0= ruleExpresionLogica ) )? otherlv_3= '{' ( (lv_validador_4_0= ruleLinea ) )* otherlv_5= '}'
            {
            // InternalBlockchain.g:1331:3: ()
            // InternalBlockchain.g:1332:4: 
            {

            				current = forceCreateModelElement(
            					grammarAccess.getCondicionalAccess().getCondicionalAction_0(),
            					current);
            ...
            otherlv_1=(Token)match(input,30,FOLLOW_27); 
            			...
            			newLeafNode(otherlv_1, grammarAccess.getCondicionalAccess().getIfKeyword_1());
            		
            // InternalBlockchain.g:1342:3: ( (lv_expresionlogica_2_0= ruleExpresionLogica ) )?
            int alt36=2;
            ...
            switch (alt36) {
                case 1 :
                    // InternalBlockchain.g:1343:4: (lv_expresionlogica_2_0= ruleExpresionLogica )
                    {
                    // InternalBlockchain.g:1343:4: (lv_expresionlogica_2_0= ruleExpresionLogica )
                    // InternalBlockchain.g:1344:5: lv_expresionlogica_2_0= ruleExpresionLogica
                    {
            ...
            otherlv_3=(Token)match(input,12,FOLLOW_28); 
            			...
            			newLeafNode(otherlv_3, grammarAccess.getCondicionalAccess().getLeftCurlyBracketKeyword_3());
            		
            // InternalBlockchain.g:1365:3: ( (lv_validador_4_0= ruleLinea ) )*
            loop37:
            do {
                int alt37=2;
                int LA37_0 = input.LA(1);

                if ( ((LA37_0>=27 && LA37_0<=34)||LA37_0==36) ) {
                    alt37=1;
                }
                ...
                switch (alt37) {
            	case 1 :
            	    // InternalBlockchain.g:1366:4: (lv_validador_4_0= ruleLinea )
            	    {
            	    // InternalBlockchain.g:1366:4: (lv_validador_4_0= ruleLinea )
            	    // InternalBlockchain.g:1367:5: lv_validador_4_0= ruleLinea
            	    {

            	    					newCompositeNode(grammarAccess.getCondicionalAccess().getValidadorLineaParserRuleCall_4_0());
            	    				
            	    pushFollow(FOLLOW_28);
            	    lv_validador_4_0=ruleLinea();
    ...
    // InternalBlockchain.g:1392:1: entryRuleExpresionNumerica returns [EObject current=null] : iv_ruleExpresionNumerica= ruleExpresionNumerica EOF ;
    public final EObject entryRuleExpresionNumerica() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1392:58: (iv_ruleExpresionNumerica= ruleExpresionNumerica EOF )
            // InternalBlockchain.g:1393:2: iv_ruleExpresionNumerica= ruleExpresionNumerica EOF
            {
    ...
    // InternalBlockchain.g:1399:1: ruleExpresionNumerica returns [EObject current=null] : ( () otherlv_1= 'ExpNum' ( (lv_value_2_0= ruleEDouble ) )? ) ;
    public final EObject ruleExpresionNumerica() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1405:2: ( ( () otherlv_1= 'ExpNum' ( (lv_value_2_0= ruleEDouble ) )? ) )
            // InternalBlockchain.g:1406:2: ( () otherlv_1= 'ExpNum' ( (lv_value_2_0= ruleEDouble ) )? )
            {
            // InternalBlockchain.g:1406:2: ( () otherlv_1= 'ExpNum' ( (lv_value_2_0= ruleEDouble ) )? )
            // InternalBlockchain.g:1407:3: () otherlv_1= 'ExpNum' ( (lv_value_2_0= ruleEDouble ) )?
            {
            // InternalBlockchain.g:1407:3: ()
            // InternalBlockchain.g:1408:4: 
            {
            ...
            // InternalBlockchain.g:1418:3: ( (lv_value_2_0= ruleEDouble ) )?
            int alt38=2;
            switch ( input.LA(1) ) {
                case 37:
                    {
            ...
            switch (alt38) {
                case 1 :
                    // InternalBlockchain.g:1419:4: (lv_value_2_0= ruleEDouble )
                    {
                    // InternalBlockchain.g:1419:4: (lv_value_2_0= ruleEDouble )
                    // InternalBlockchain.g:1420:5: lv_value_2_0= ruleEDouble
                    {
    ...
    // InternalBlockchain.g:1441:1: entryRuleExpresionTexto returns [EObject current=null] : iv_ruleExpresionTexto= ruleExpresionTexto EOF ;
    public final EObject entryRuleExpresionTexto() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1441:55: (iv_ruleExpresionTexto= ruleExpresionTexto EOF )
            // InternalBlockchain.g:1442:2: iv_ruleExpresionTexto= ruleExpresionTexto EOF
            {
    ...
    // InternalBlockchain.g:1448:1: ruleExpresionTexto returns [EObject current=null] : ( () otherlv_1= 'ExpTex' ( (lv_value_2_0= ruleEString ) )? ) ;
    public final EObject ruleExpresionTexto() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1454:2: ( ( () otherlv_1= 'ExpTex' ( (lv_value_2_0= ruleEString ) )? ) )
            // InternalBlockchain.g:1455:2: ( () otherlv_1= 'ExpTex' ( (lv_value_2_0= ruleEString ) )? )
            {
            // InternalBlockchain.g:1455:2: ( () otherlv_1= 'ExpTex' ( (lv_value_2_0= ruleEString ) )? )
            // InternalBlockchain.g:1456:3: () otherlv_1= 'ExpTex' ( (lv_value_2_0= ruleEString ) )?
            {
            // InternalBlockchain.g:1456:3: ()
            // InternalBlockchain.g:1457:4: 
            {
            ...
            // InternalBlockchain.g:1467:3: ( (lv_value_2_0= ruleEString ) )?
            int alt39=2;
            ...
            switch (alt39) {
                case 1 :
                    // InternalBlockchain.g:1468:4: (lv_value_2_0= ruleEString )
                    {
                    // InternalBlockchain.g:1468:4: (lv_value_2_0= ruleEString )
                    // InternalBlockchain.g:1469:5: lv_value_2_0= ruleEString
                    {
    ...
    // InternalBlockchain.g:1490:1: entryRuleExpresionBoolean returns [EObject current=null] : iv_ruleExpresionBoolean= ruleExpresionBoolean EOF ;
    public final EObject entryRuleExpresionBoolean() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1490:57: (iv_ruleExpresionBoolean= ruleExpresionBoolean EOF )
            // InternalBlockchain.g:1491:2: iv_ruleExpresionBoolean= ruleExpresionBoolean EOF
            {
    ...
    // InternalBlockchain.g:1497:1: ruleExpresionBoolean returns [EObject current=null] : ( () otherlv_1= 'ExpBool' ( (lv_value_2_0= ruleEBoolean ) )? ) ;
    public final EObject ruleExpresionBoolean() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1503:2: ( ( () otherlv_1= 'ExpBool' ( (lv_value_2_0= ruleEBoolean ) )? ) )
            // InternalBlockchain.g:1504:2: ( () otherlv_1= 'ExpBool' ( (lv_value_2_0= ruleEBoolean ) )? )
            {
            // InternalBlockchain.g:1504:2: ( () otherlv_1= 'ExpBool' ( (lv_value_2_0= ruleEBoolean ) )? )
            // InternalBlockchain.g:1505:3: () otherlv_1= 'ExpBool' ( (lv_value_2_0= ruleEBoolean ) )?
            {
            // InternalBlockchain.g:1505:3: ()
            // InternalBlockchain.g:1506:4: 
            {
            ...
            // InternalBlockchain.g:1516:3: ( (lv_value_2_0= ruleEBoolean ) )?
            int alt40=2;
            ...
            switch (alt40) {
                case 1 :
                    // InternalBlockchain.g:1517:4: (lv_value_2_0= ruleEBoolean )
                    {
                    // InternalBlockchain.g:1517:4: (lv_value_2_0= ruleEBoolean )
                    // InternalBlockchain.g:1518:5: lv_value_2_0= ruleEBoolean
                    {
    ...
    // InternalBlockchain.g:1539:1: entryRuleExpresionReferenciada returns [EObject current=null] : iv_ruleExpresionReferenciada= ruleExpresionReferenciada EOF ;
    public final EObject entryRuleExpresionReferenciada() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1539:62: (iv_ruleExpresionReferenciada= ruleExpresionReferenciada EOF )
            // InternalBlockchain.g:1540:2: iv_ruleExpresionReferenciada= ruleExpresionReferenciada EOF
            {
    ...
    // InternalBlockchain.g:1546:1: ruleExpresionReferenciada returns [EObject current=null] : (otherlv_0= 'ExpRef' otherlv_1= '{' (otherlv_2= 'id' ( (lv_id_3_0= ruleEInt ) ) )? ( ( ruleEString ) ) otherlv_5= '}' ) ;
    public final EObject ruleExpresionReferenciada() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1552:2: ( (otherlv_0= 'ExpRef' otherlv_1= '{' (otherlv_2= 'id' ( (lv_id_3_0= ruleEInt ) ) )? ( ( ruleEString ) ) otherlv_5= '}' ) )
            // InternalBlockchain.g:1553:2: (otherlv_0= 'ExpRef' otherlv_1= '{' (otherlv_2= 'id' ( (lv_id_3_0= ruleEInt ) ) )? ( ( ruleEString ) ) otherlv_5= '}' )
            {
            // InternalBlockchain.g:1553:2: (otherlv_0= 'ExpRef' otherlv_1= '{' (otherlv_2= 'id' ( (lv_id_3_0= ruleEInt ) ) )? ( ( ruleEString ) ) otherlv_5= '}' )
            // InternalBlockchain.g:1554:3: otherlv_0= 'ExpRef' otherlv_1= '{' (otherlv_2= 'id' ( (lv_id_3_0= ruleEInt ) ) )? ( ( ruleEString ) ) otherlv_5= '}'
            {
            ...
            // InternalBlockchain.g:1562:3: (otherlv_2= 'id' ( (lv_id_3_0= ruleEInt ) ) )?
            int alt41=2;
            ...
            switch (alt41) {
                case 1 :
                    // InternalBlockchain.g:1563:4: otherlv_2= 'id' ( (lv_id_3_0= ruleEInt ) )
                    {
                    ...
                    // InternalBlockchain.g:1567:4: ( (lv_id_3_0= ruleEInt ) )
                    // InternalBlockchain.g:1568:5: (lv_id_3_0= ruleEInt )
                    {
                    // InternalBlockchain.g:1568:5: (lv_id_3_0= ruleEInt )
                    // InternalBlockchain.g:1569:6: lv_id_3_0= ruleEInt
                    {
            ...
            // InternalBlockchain.g:1587:3: ( ( ruleEString ) )
            // InternalBlockchain.g:1588:4: ( ruleEString )
            {
            // InternalBlockchain.g:1588:4: ( ruleEString )
            // InternalBlockchain.g:1589:5: ruleEString
            {
    ...
    // InternalBlockchain.g:1611:1: entryRuleExpresionRelacional returns [EObject current=null] : iv_ruleExpresionRelacional= ruleExpresionRelacional EOF ;
    public final EObject entryRuleExpresionRelacional() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1611:60: (iv_ruleExpresionRelacional= ruleExpresionRelacional EOF )
            // InternalBlockchain.g:1612:2: iv_ruleExpresionRelacional= ruleExpresionRelacional EOF
            {
    ...
    // InternalBlockchain.g:1618:1: ruleExpresionRelacional returns [EObject current=null] : (otherlv_0= 'ExpRel' ( (lv_izq_1_0= ruleExpresion ) ) ( (lv_operadorRelacional_2_0= ruleOperadorRelacion ) )? ( (lv_der_3_0= ruleExpresion ) ) ) ;
    public final EObject ruleExpresionRelacional() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1624:2: ( (otherlv_0= 'ExpRel' ( (lv_izq_1_0= ruleExpresion ) ) ( (lv_operadorRelacional_2_0= ruleOperadorRelacion ) )? ( (lv_der_3_0= ruleExpresion ) ) ) )
            // InternalBlockchain.g:1625:2: (otherlv_0= 'ExpRel' ( (lv_izq_1_0= ruleExpresion ) ) ( (lv_operadorRelacional_2_0= ruleOperadorRelacion ) )? ( (lv_der_3_0= ruleExpresion ) ) )
            {
            // InternalBlockchain.g:1625:2: (otherlv_0= 'ExpRel' ( (lv_izq_1_0= ruleExpresion ) ) ( (lv_operadorRelacional_2_0= ruleOperadorRelacion ) )? ( (lv_der_3_0= ruleExpresion ) ) )
            // InternalBlockchain.g:1626:3: otherlv_0= 'ExpRel' ( (lv_izq_1_0= ruleExpresion ) ) ( (lv_operadorRelacional_2_0= ruleOperadorRelacion ) )? ( (lv_der_3_0= ruleExpresion ) )
            {
            ...
            // InternalBlockchain.g:1630:3: ( (lv_izq_1_0= ruleExpresion ) )
            // InternalBlockchain.g:1631:4: (lv_izq_1_0= ruleExpresion )
            {
            // InternalBlockchain.g:1631:4: (lv_izq_1_0= ruleExpresion )
            // InternalBlockchain.g:1632:5: lv_izq_1_0= ruleExpresion
            {
            ...
            // InternalBlockchain.g:1649:3: ( (lv_operadorRelacional_2_0= ruleOperadorRelacion ) )?
            int alt42=2;
            ...
            switch (alt42) {
                case 1 :
                    // InternalBlockchain.g:1650:4: (lv_operadorRelacional_2_0= ruleOperadorRelacion )
                    {
                    // InternalBlockchain.g:1650:4: (lv_operadorRelacional_2_0= ruleOperadorRelacion )
                    // InternalBlockchain.g:1651:5: lv_operadorRelacional_2_0= ruleOperadorRelacion
                    {
            ...
            // InternalBlockchain.g:1668:3: ( (lv_der_3_0= ruleExpresion ) )
            // InternalBlockchain.g:1669:4: (lv_der_3_0= ruleExpresion )
            {
            // InternalBlockchain.g:1669:4: (lv_der_3_0= ruleExpresion )
            // InternalBlockchain.g:1670:5: lv_der_3_0= ruleExpresion
            {
    ...
    // InternalBlockchain.g:1691:1: entryRuleEDouble returns [String current=null] : iv_ruleEDouble= ruleEDouble EOF ;
    public final String entryRuleEDouble() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1691:47: (iv_ruleEDouble= ruleEDouble EOF )
            // InternalBlockchain.g:1692:2: iv_ruleEDouble= ruleEDouble EOF
            {
    ...
    // InternalBlockchain.g:1698:1: ruleEDouble returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : ( (kw= '-' )? (this_INT_1= RULE_INT )? kw= '.' this_INT_3= RULE_INT ( (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT )? ) ;
    public final AntlrDatatypeRuleToken ruleEDouble() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1704:2: ( ( (kw= '-' )? (this_INT_1= RULE_INT )? kw= '.' this_INT_3= RULE_INT ( (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT )? ) )
            // InternalBlockchain.g:1705:2: ( (kw= '-' )? (this_INT_1= RULE_INT )? kw= '.' this_INT_3= RULE_INT ( (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT )? )
            {
            // InternalBlockchain.g:1705:2: ( (kw= '-' )? (this_INT_1= RULE_INT )? kw= '.' this_INT_3= RULE_INT ( (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT )? )
            // InternalBlockchain.g:1706:3: (kw= '-' )? (this_INT_1= RULE_INT )? kw= '.' this_INT_3= RULE_INT ( (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT )?
            {
            // InternalBlockchain.g:1706:3: (kw= '-' )?
            int alt43=2;
            ...
            switch (alt43) {
                case 1 :
                    // InternalBlockchain.g:1707:4: kw= '-'
                    {
            ...
            // InternalBlockchain.g:1713:3: (this_INT_1= RULE_INT )?
            int alt44=2;
            ...
            switch (alt44) {
                case 1 :
                    // InternalBlockchain.g:1714:4: this_INT_1= RULE_INT
                    {
            ...
            // InternalBlockchain.g:1734:3: ( (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT )?
            int alt47=2;
            ...
            switch (alt47) {
                case 1 :
                    // InternalBlockchain.g:1735:4: (kw= 'E' | kw= 'e' ) (kw= '-' )? this_INT_7= RULE_INT
                    {
                    // InternalBlockchain.g:1735:4: (kw= 'E' | kw= 'e' )
                    int alt45=2;
                    ...
                    switch (alt45) {
                        case 1 :
                            // InternalBlockchain.g:1736:5: kw= 'E'
                            {
                            ...
                            break;
                        case 2 :
                            // InternalBlockchain.g:1742:5: kw= 'e'
                            {
                    ...
                    // InternalBlockchain.g:1748:4: (kw= '-' )?
                    int alt46=2;
                    ...
                    switch (alt46) {
                        case 1 :
                            // InternalBlockchain.g:1749:5: kw= '-'
                            {
    ...
    // InternalBlockchain.g:1767:1: entryRuleEInt returns [String current=null] : iv_ruleEInt= ruleEInt EOF ;
    public final String entryRuleEInt() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1767:44: (iv_ruleEInt= ruleEInt EOF )
            // InternalBlockchain.g:1768:2: iv_ruleEInt= ruleEInt EOF
            {
    ...
    // InternalBlockchain.g:1774:1: ruleEInt returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : ( (kw= '-' )? this_INT_1= RULE_INT ) ;
    public final AntlrDatatypeRuleToken ruleEInt() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1780:2: ( ( (kw= '-' )? this_INT_1= RULE_INT ) )
            // InternalBlockchain.g:1781:2: ( (kw= '-' )? this_INT_1= RULE_INT )
            {
            // InternalBlockchain.g:1781:2: ( (kw= '-' )? this_INT_1= RULE_INT )
            // InternalBlockchain.g:1782:3: (kw= '-' )? this_INT_1= RULE_INT
            {
            // InternalBlockchain.g:1782:3: (kw= '-' )?
            int alt48=2;
            ...
            switch (alt48) {
                case 1 :
                    // InternalBlockchain.g:1783:4: kw= '-'
                    {
                    kw=(Token)match(input,37,FOLLOW_38); 
    ...
    // InternalBlockchain.g:1800:1: entryRulePrimitivo returns [EObject current=null] : iv_rulePrimitivo= rulePrimitivo EOF ;
    public final EObject entryRulePrimitivo() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1800:50: (iv_rulePrimitivo= rulePrimitivo EOF )
            // InternalBlockchain.g:1801:2: iv_rulePrimitivo= rulePrimitivo EOF
            {
    ...
    // InternalBlockchain.g:1807:1: rulePrimitivo returns [EObject current=null] : ( () ( (lv_tipo_1_0= ruleDatoPrimitivo ) )? ( (lv_name_2_0= ruleEString ) ) ) ;
    public final EObject rulePrimitivo() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1813:2: ( ( () ( (lv_tipo_1_0= ruleDatoPrimitivo ) )? ( (lv_name_2_0= ruleEString ) ) ) )
            // InternalBlockchain.g:1814:2: ( () ( (lv_tipo_1_0= ruleDatoPrimitivo ) )? ( (lv_name_2_0= ruleEString ) ) )
            {
            // InternalBlockchain.g:1814:2: ( () ( (lv_tipo_1_0= ruleDatoPrimitivo ) )? ( (lv_name_2_0= ruleEString ) ) )
            // InternalBlockchain.g:1815:3: () ( (lv_tipo_1_0= ruleDatoPrimitivo ) )? ( (lv_name_2_0= ruleEString ) )
            {
            // InternalBlockchain.g:1815:3: ()
            // InternalBlockchain.g:1816:4: 
            {
            ...
            // InternalBlockchain.g:1822:3: ( (lv_tipo_1_0= ruleDatoPrimitivo ) )?
            int alt49=2;
            int LA49_0 = input.LA(1);

            if ( ((LA49_0>=56 && LA49_0<=59)) ) {
                alt49=1;
            }
            switch (alt49) {
                case 1 :
                    // InternalBlockchain.g:1823:4: (lv_tipo_1_0= ruleDatoPrimitivo )
                    {
                    // InternalBlockchain.g:1823:4: (lv_tipo_1_0= ruleDatoPrimitivo )
                    // InternalBlockchain.g:1824:5: lv_tipo_1_0= ruleDatoPrimitivo
                    {
            ...
            // InternalBlockchain.g:1841:3: ( (lv_name_2_0= ruleEString ) )
            // InternalBlockchain.g:1842:4: (lv_name_2_0= ruleEString )
            {
            // InternalBlockchain.g:1842:4: (lv_name_2_0= ruleEString )
            // InternalBlockchain.g:1843:5: lv_name_2_0= ruleEString
            {
    ...
    // InternalBlockchain.g:1864:1: entryRuleMapa returns [EObject current=null] : iv_ruleMapa= ruleMapa EOF ;
    public final EObject entryRuleMapa() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1864:45: (iv_ruleMapa= ruleMapa EOF )
            // InternalBlockchain.g:1865:2: iv_ruleMapa= ruleMapa EOF
            {
    ...
    // InternalBlockchain.g:1871:1: ruleMapa returns [EObject current=null] : (otherlv_0= 'Map' otherlv_1= '<' ( ( ruleEString ) ) otherlv_3= ',' ( ( ruleEString ) ) otherlv_5= '>' otherlv_6= ':' ( (lv_name_7_0= ruleEString ) ) ) ;
    public final EObject ruleMapa() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1877:2: ( (otherlv_0= 'Map' otherlv_1= '<' ( ( ruleEString ) ) otherlv_3= ',' ( ( ruleEString ) ) otherlv_5= '>' otherlv_6= ':' ( (lv_name_7_0= ruleEString ) ) ) )
            // InternalBlockchain.g:1878:2: (otherlv_0= 'Map' otherlv_1= '<' ( ( ruleEString ) ) otherlv_3= ',' ( ( ruleEString ) ) otherlv_5= '>' otherlv_6= ':' ( (lv_name_7_0= ruleEString ) ) )
            {
            // InternalBlockchain.g:1878:2: (otherlv_0= 'Map' otherlv_1= '<' ( ( ruleEString ) ) otherlv_3= ',' ( ( ruleEString ) ) otherlv_5= '>' otherlv_6= ':' ( (lv_name_7_0= ruleEString ) ) )
            // InternalBlockchain.g:1879:3: otherlv_0= 'Map' otherlv_1= '<' ( ( ruleEString ) ) otherlv_3= ',' ( ( ruleEString ) ) otherlv_5= '>' otherlv_6= ':' ( (lv_name_7_0= ruleEString ) )
            {
            ...
            // InternalBlockchain.g:1887:3: ( ( ruleEString ) )
            // InternalBlockchain.g:1888:4: ( ruleEString )
            {
            // InternalBlockchain.g:1888:4: ( ruleEString )
            // InternalBlockchain.g:1889:5: ruleEString
            {
            ...
            // InternalBlockchain.g:1907:3: ( ( ruleEString ) )
            // InternalBlockchain.g:1908:4: ( ruleEString )
            {
            // InternalBlockchain.g:1908:4: ( ruleEString )
            // InternalBlockchain.g:1909:5: ruleEString
            {
            ...
            // InternalBlockchain.g:1931:3: ( (lv_name_7_0= ruleEString ) )
            // InternalBlockchain.g:1932:4: (lv_name_7_0= ruleEString )
            {
            // InternalBlockchain.g:1932:4: (lv_name_7_0= ruleEString )
            // InternalBlockchain.g:1933:5: lv_name_7_0= ruleEString
            {
    ...
    // InternalBlockchain.g:1954:1: ruleOperadorLogico returns [Enumerator current=null] : ( (enumLiteral_0= '==' ) | (enumLiteral_1= '!=' ) | (enumLiteral_2= '>' ) | (enumLiteral_3= '<' ) | (enumLiteral_4= '>=' ) | (enumLiteral_5= '<=' ) | (enumLiteral_6= '&&' ) | (enumLiteral_7= '||' ) ) ;
    public final Enumerator ruleOperadorLogico() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:1960:2: ( ( (enumLiteral_0= '==' ) | (enumLiteral_1= '!=' ) | (enumLiteral_2= '>' ) | (enumLiteral_3= '<' ) | (enumLiteral_4= '>=' ) | (enumLiteral_5= '<=' ) | (enumLiteral_6= '&&' ) | (enumLiteral_7= '||' ) ) )
            // InternalBlockchain.g:1961:2: ( (enumLiteral_0= '==' ) | (enumLiteral_1= '!=' ) | (enumLiteral_2= '>' ) | (enumLiteral_3= '<' ) | (enumLiteral_4= '>=' ) | (enumLiteral_5= '<=' ) | (enumLiteral_6= '&&' ) | (enumLiteral_7= '||' ) )
            {
            // InternalBlockchain.g:1961:2: ( (enumLiteral_0= '==' ) | (enumLiteral_1= '!=' ) | (enumLiteral_2= '>' ) | (enumLiteral_3= '<' ) | (enumLiteral_4= '>=' ) | (enumLiteral_5= '<=' ) | (enumLiteral_6= '&&' ) | (enumLiteral_7= '||' ) )
            int alt50=8;
            switch ( input.LA(1) ) {
            ...
            switch (alt50) {
                case 1 :
                    // InternalBlockchain.g:1962:3: (enumLiteral_0= '==' )
                    {
                    // InternalBlockchain.g:1962:3: (enumLiteral_0= '==' )
                    // InternalBlockchain.g:1963:4: enumLiteral_0= '=='
                    {
                    ...
                    break;
                case 2 :
                    // InternalBlockchain.g:1970:3: (enumLiteral_1= '!=' )
                    {
                    // InternalBlockchain.g:1970:3: (enumLiteral_1= '!=' )
                    // InternalBlockchain.g:1971:4: enumLiteral_1= '!='
                    {
                    ...
                    break;
                case 3 :
                    // InternalBlockchain.g:1978:3: (enumLiteral_2= '>' )
                    {
                    // InternalBlockchain.g:1978:3: (enumLiteral_2= '>' )
                    // InternalBlockchain.g:1979:4: enumLiteral_2= '>'
                    {
                    ...
                    break;
                case 4 :
                    // InternalBlockchain.g:1986:3: (enumLiteral_3= '<' )
                    {
                    // InternalBlockchain.g:1986:3: (enumLiteral_3= '<' )
                    // InternalBlockchain.g:1987:4: enumLiteral_3= '<'
                    {
                    ...
                    break;
                case 5 :
                    // InternalBlockchain.g:1994:3: (enumLiteral_4= '>=' )
                    {
                    // InternalBlockchain.g:1994:3: (enumLiteral_4= '>=' )
                    // InternalBlockchain.g:1995:4: enumLiteral_4= '>='
                    {
                    ...
                    break;
                case 6 :
                    // InternalBlockchain.g:2002:3: (enumLiteral_5= '<=' )
                    {
                    // InternalBlockchain.g:2002:3: (enumLiteral_5= '<=' )
                    // InternalBlockchain.g:2003:4: enumLiteral_5= '<='
                    {
                    ...
                    break;
                case 7 :
                    // InternalBlockchain.g:2010:3: (enumLiteral_6= '&&' )
                    {
                    // InternalBlockchain.g:2010:3: (enumLiteral_6= '&&' )
                    // InternalBlockchain.g:2011:4: enumLiteral_6= '&&'
                    {
                    ...
                    break;
                case 8 :
                    // InternalBlockchain.g:2018:3: (enumLiteral_7= '||' )
                    {
                    // InternalBlockchain.g:2018:3: (enumLiteral_7= '||' )
                    // InternalBlockchain.g:2019:4: enumLiteral_7= '||'
                    {
    ...
    // InternalBlockchain.g:2029:1: ruleOperador returns [Enumerator current=null] : ( (enumLiteral_0= '+' ) | (enumLiteral_1= '-' ) | (enumLiteral_2= '*' ) | (enumLiteral_3= '/' ) | (enumLiteral_4= '=' ) | (enumLiteral_5= 'GET' ) | (enumLiteral_6= 'DELETE' ) ) ;
    public final Enumerator ruleOperador() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:2035:2: ( ( (enumLiteral_0= '+' ) | (enumLiteral_1= '-' ) | (enumLiteral_2= '*' ) | (enumLiteral_3= '/' ) | (enumLiteral_4= '=' ) | (enumLiteral_5= 'GET' ) | (enumLiteral_6= 'DELETE' ) ) )
            // InternalBlockchain.g:2036:2: ( (enumLiteral_0= '+' ) | (enumLiteral_1= '-' ) | (enumLiteral_2= '*' ) | (enumLiteral_3= '/' ) | (enumLiteral_4= '=' ) | (enumLiteral_5= 'GET' ) | (enumLiteral_6= 'DELETE' ) )
            {
            // InternalBlockchain.g:2036:2: ( (enumLiteral_0= '+' ) | (enumLiteral_1= '-' ) | (enumLiteral_2= '*' ) | (enumLiteral_3= '/' ) | (enumLiteral_4= '=' ) | (enumLiteral_5= 'GET' ) | (enumLiteral_6= 'DELETE' ) )
            int alt51=7;
            switch ( input.LA(1) ) {
            ...
            switch (alt51) {
                case 1 :
                    // InternalBlockchain.g:2037:3: (enumLiteral_0= '+' )
                    {
                    // InternalBlockchain.g:2037:3: (enumLiteral_0= '+' )
                    // InternalBlockchain.g:2038:4: enumLiteral_0= '+'
                    {
                    ...
                    break;
                case 2 :
                    // InternalBlockchain.g:2045:3: (enumLiteral_1= '-' )
                    {
                    // InternalBlockchain.g:2045:3: (enumLiteral_1= '-' )
                    // InternalBlockchain.g:2046:4: enumLiteral_1= '-'
                    {
                    ...
                    break;
                case 3 :
                    // InternalBlockchain.g:2053:3: (enumLiteral_2= '*' )
                    {
                    // InternalBlockchain.g:2053:3: (enumLiteral_2= '*' )
                    // InternalBlockchain.g:2054:4: enumLiteral_2= '*'
                    {
                    ...
                    break;
                case 4 :
                    // InternalBlockchain.g:2061:3: (enumLiteral_3= '/' )
                    {
                    // InternalBlockchain.g:2061:3: (enumLiteral_3= '/' )
                    // InternalBlockchain.g:2062:4: enumLiteral_3= '/'
                    {
                    ...
                    break;
                case 5 :
                    // InternalBlockchain.g:2069:3: (enumLiteral_4= '=' )
                    {
                    // InternalBlockchain.g:2069:3: (enumLiteral_4= '=' )
                    // InternalBlockchain.g:2070:4: enumLiteral_4= '='
                    {
                    ...
                    break;
                case 6 :
                    // InternalBlockchain.g:2077:3: (enumLiteral_5= 'GET' )
                    {
                    // InternalBlockchain.g:2077:3: (enumLiteral_5= 'GET' )
                    // InternalBlockchain.g:2078:4: enumLiteral_5= 'GET'
                    {
                    ...
                    break;
                case 7 :
                    // InternalBlockchain.g:2085:3: (enumLiteral_6= 'DELETE' )
                    {
                    // InternalBlockchain.g:2085:3: (enumLiteral_6= 'DELETE' )
                    // InternalBlockchain.g:2086:4: enumLiteral_6= 'DELETE'
                    {
    ...
    // InternalBlockchain.g:2096:1: ruleOperadorRelacion returns [Enumerator current=null] : (enumLiteral_0= '.' ) ;
    public final Enumerator ruleOperadorRelacion() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:2102:2: ( (enumLiteral_0= '.' ) )
            // InternalBlockchain.g:2103:2: (enumLiteral_0= '.' )
            {
            // InternalBlockchain.g:2103:2: (enumLiteral_0= '.' )
            // InternalBlockchain.g:2104:3: enumLiteral_0= '.'
            {
    ...
    // InternalBlockchain.g:2113:1: ruleDatoPrimitivo returns [Enumerator current=null] : ( (enumLiteral_0= 'String' ) | (enumLiteral_1= 'uint' ) | (enumLiteral_2= 'Boolean' ) | (enumLiteral_3= 'address' ) ) ;
    public final Enumerator ruleDatoPrimitivo() throws RecognitionException {
        ...
        try {
            // InternalBlockchain.g:2119:2: ( ( (enumLiteral_0= 'String' ) | (enumLiteral_1= 'uint' ) | (enumLiteral_2= 'Boolean' ) | (enumLiteral_3= 'address' ) ) )
            // InternalBlockchain.g:2120:2: ( (enumLiteral_0= 'String' ) | (enumLiteral_1= 'uint' ) | (enumLiteral_2= 'Boolean' ) | (enumLiteral_3= 'address' ) )
            {
            // InternalBlockchain.g:2120:2: ( (enumLiteral_0= 'String' ) | (enumLiteral_1= 'uint' ) | (enumLiteral_2= 'Boolean' ) | (enumLiteral_3= 'address' ) )
            int alt52=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt52) {
                case 1 :
                    // InternalBlockchain.g:2121:3: (enumLiteral_0= 'String' )
                    {
                    // InternalBlockchain.g:2121:3: (enumLiteral_0= 'String' )
                    // InternalBlockchain.g:2122:4: enumLiteral_0= 'String'
                    {
                    ...
                    break;
                case 2 :
                    // InternalBlockchain.g:2129:3: (enumLiteral_1= 'uint' )
                    {
                    // InternalBlockchain.g:2129:3: (enumLiteral_1= 'uint' )
                    // InternalBlockchain.g:2130:4: enumLiteral_1= 'uint'
                    {
                    ...
                    break;
                case 3 :
                    // InternalBlockchain.g:2137:3: (enumLiteral_2= 'Boolean' )
                    {
                    // InternalBlockchain.g:2137:3: (enumLiteral_2= 'Boolean' )
                    // InternalBlockchain.g:2138:4: enumLiteral_2= 'Boolean'
                    {
                    ...
                    break;
                case 4 :
                    // InternalBlockchain.g:2145:3: (enumLiteral_3= 'address' )
                    {
                    // InternalBlockchain.g:2145:3: (enumLiteral_3= 'address' )
                    // InternalBlockchain.g:2146:4: enumLiteral_3= 'address'
                    {
    ...
    public static final BitSet FOLLOW_18 = new BitSet(new long[]{0x00000017F8A84000L});
    public static final BitSet FOLLOW_19 = new BitSet(new long[]{0x00000017F8284000L});
    public static final BitSet FOLLOW_20 = new BitSet(new long[]{0x00000017F8204000L});
    public static final BitSet FOLLOW_21 = new BitSet(new long[]{0x0000000000204000L});
    public static final BitSet FOLLOW_22 = new BitSet(new long[]{0x0000001798080000L});
    public static final BitSet FOLLOW_23 = new BitSet(new long[]{0x0003FC1798280000L});
    public static final BitSet FOLLOW_24 = new BitSet(new long[]{0x0000000000200002L});
    public static final BitSet FOLLOW_25 = new BitSet(new long[]{0x00FC003798280000L});
    ...
    public static final BitSet FOLLOW_28 = new BitSet(new long[]{0x00000017F8004000L});
    public static final BitSet FOLLOW_29 = new BitSet(new long[]{0x0000006000000042L});
    public static final BitSet FOLLOW_30 = new BitSet(new long[]{0x0000000006000002L});
    ...
    public static final BitSet FOLLOW_34 = new BitSet(new long[]{0x0000001798000000L});
    public static final BitSet FOLLOW_35 = new BitSet(new long[]{0x0000005798000000L});
    public static final BitSet FOLLOW_36 = new BitSet(new long[]{0x0000004000000040L});
