...
public class BlockchainGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class CondicionalElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cElseElseParserRuleCall_5_0 = (RuleCall)cElseAssignment_5.eContents().get(0);
		...
		//'if' expresionlogica=ExpresionLogica? '{' lineas+=Linea* '}' else=Else?
		public Group getGroup() { return cGroup; }
		...
		//Else
		public RuleCall getElseElseParserRuleCall_5_0() { return cElseElseParserRuleCall_5_0; }
	}
