...
/**
 * This is the item provider adapter for a {@link blockchain.Atributo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Atributo_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Atributo_name_feature", "_UI_Atributo_type"),
				 BlockchainPackage.Literals.ATRIBUTO__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BlockchainPackage.Literals.ATRIBUTO__TIPODATO,
				 true,
				 false,
				 true,
				 null,
