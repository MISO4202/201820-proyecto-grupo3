...
/**
 * This is the item provider adapter for a {@link blockchain.ExpresionLogica} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExpresionLogicaItemProvider extends ExpresionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExpresionLogica_operador_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExpresionLogica_operador_feature", "_UI_ExpresionLogica_type"),
				 BlockchainPackage.Literals.EXPRESION_LOGICA__OPERADOR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		ExpresionLogica expresionLogica = (ExpresionLogica)object;
		return getString("_UI_ExpresionLogica_type") + " " + expresionLogica.getId();
	}
