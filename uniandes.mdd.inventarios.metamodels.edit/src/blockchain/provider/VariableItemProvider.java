...
/**
 * This is the item provider adapter for a {@link blockchain.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider extends SentenciaItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_tipodato_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_tipodato_feature", "_UI_Variable_type"),
				 BlockchainPackage.Literals.VARIABLE__TIPODATO,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BlockchainPackage.Literals.VARIABLE__NAME,
				 true,
				 false,
				 false,
