...
@after {
	...
	(
		...
		{
			$current = $this_ExpresionTexto_7.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ExpresionBoolean_8.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
